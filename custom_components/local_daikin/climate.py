...
class LocalDaikin(ClimateEntity):
    def __init__(self, ip_address: str):
        ...
        self._attr_supported_features = ClimateEntityFeature.TARGET_TEMPERATURE | ClimateEntityFeature.TURN_OFF | ClimateEntityFeature.TURN_ON | ClimateEntityFeature.SWING_MODE
